...
# ==============================================================================
# Secrets Manager Outputs (UPDATED)
# ==============================================================================

output "db_secret_arn" {
  description = "Secrets Manager secret ARN for the auto-generated DB credentials"
  # Pulls the secret ARN dynamically generated by the manage_master_user_password feature
  value       = aws_db_instance.rds.master_user_secret[0].secret_arn
}

# Note: db_secret_name has been removed. The native RDS integration only exposes 
# the ARN directly via the master_user_secret attribute, which is all you need 
# for IAM policies and secret retrieval anyway.
